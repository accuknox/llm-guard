...
It can be particularly useful in applications that need to reject code snippets in specific languages, or any code at all.
...
prompt invalid, while code in any other language passes through. Selecting **all** supported languages - which is
