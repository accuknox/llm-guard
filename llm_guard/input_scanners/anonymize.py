...
class Anonymize(Scanner):
    ...
    def __init__(
        ...
        *,
        ...
        self._nlp_engine = get_nlp_engine(languages=list(set(["en", language])))
    ...
    def scan(
        ...
        *,
        ...
        # Use provided arguments or default instance values
        vault = vault or self._vault
        hidden_names = hidden_names if hidden_names is not None else self._hidden_names
        ...
        regex_patterns = regex_patterns if regex_patterns is not None else self._regex_patterns
